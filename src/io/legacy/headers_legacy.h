...
enum class CodeWordLengthValues : unsigned int {
	w8bit = 0b000, 
	w16bit = 0b010, 
	w24bit = 0b100, 
	w32bit = 0b110, 
...
CodeWordLengthValues getWordLengthValue(size_t bitNum) {
	if (bitNum & 0b0111 || bitNum > 64)
		throw "Invalid word length!";
	size_t &&bitNumShifted = bitNum >> 2; // most significant bit is moved to lowest position
