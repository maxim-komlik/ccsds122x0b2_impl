...
// template <typename T>
// std::unique_ptr<sink<T>> make_sink(const session_context& context, storage_type type, size_t segment_id, size_t channel_index) {
...
// template std::unique_ptr<sink<int8_t>> make_sink<int8_t>(const session_context& constext, storage_type type, size_t segment_id, size_t channel_index);
// template std::unique_ptr<sink<int16_t>> make_sink<int16_t>(const session_context& constext, storage_type type, size_t segment_id, size_t channel_index);
// template std::unique_ptr<sink<int32_t>> make_sink<int32_t>(const session_context& constext, storage_type type, size_t segment_id, size_t channel_index);
// template std::unique_ptr<sink<int64_t>> make_sink<int64_t>(const session_context& constext, storage_type type, size_t segment_id, size_t channel_index);
// 
// template std::unique_ptr<sink<uint8_t>> make_sink<uint8_t>(const session_context& constext, storage_type type, size_t segment_id, size_t channel_index);
// template std::unique_ptr<sink<uint16_t>> make_sink<uint16_t>(const session_context& constext, storage_type type, size_t segment_id, size_t channel_index);
// template std::unique_ptr<sink<uint32_t>> make_sink<uint32_t>(const session_context& constext, storage_type type, size_t segment_id, size_t channel_index);
// template std::unique_ptr<sink<uint64_t>> make_sink<uint64_t>(const session_context& constext, storage_type type, size_t segment_id, size_t channel_index);
