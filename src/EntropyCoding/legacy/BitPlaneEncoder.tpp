...
SymbolForwardTranslator symbol_translator;
...
void __encodeBpeStages(segment<T>& input, obitwrapper<obwT>& output) {
	...
	std::array<symbolstream, 3> vlwstreams {
		symbolstream(vector_with_capacity_generator.template operator()<dense_vlw_t::type>(144)),
		symbolstream(vector_with_capacity_generator.template operator()<dense_vlw_t::type>(128)),
		symbolstream(vector_with_capacity_generator.template operator()<dense_vlw_t::type>(128))
	};
